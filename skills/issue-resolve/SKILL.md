...
- **仕様整合性レビュー**: `specification`等の既存ドキュメント，他リポジトリの関連ファイル，あるいは同一ファイル内の過去の記述との間に，矛盾や対応漏れがないかを確認する．該当する変更がある場合や，仕様変更・新機能の追加によって過去の制限が撤廃された場合など，関連箇所の更新漏れが起きやすい状況で行う

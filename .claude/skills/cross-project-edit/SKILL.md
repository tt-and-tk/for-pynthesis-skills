...
レビュー指摘のうち対応すべきと判断したものは，ユーザーに提示する前に方針へ反映する(対応方針は末尾「レビュー指摘への向き合い方」を参照)．
...
修正すべきと判断した指摘がなくなるまで，人間の確認なしに修正・再レビューを繰り返す．指摘事項一つずつについてコミットを行う(プッシュはまとめてよい)．対応方針は末尾「レビュー指摘への向き合い方」を参照．
